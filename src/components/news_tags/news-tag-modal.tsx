...
import { handleDeleteNewsTagAction } from "@/utils/action";
import NewsTagCreateModal from "./news-tag-create-modal";
import NewsTagUpdateModal from "./news-tag-update-modal";
...
const NewsTagsModal = (props: IProps) => {
  ...
  const handleDeleteTag = async (tagId: string) => {
    const res = await handleDeleteNewsTagAction(tagId);
    if (res?.data) {
