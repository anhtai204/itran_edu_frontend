...
import { handleUpdateNewsTagAction } from "@/utils/action"
...
const NewsTagUpdateModal = (props: IProps) => {
  ...
  useEffect(() => {
    if (dataUpdate) {
      ...
      setFormData({
        ...
        slug: dataUpdate.slug ? (dataUpdate.slug.trim() ?? "") : "",
      })
    }
  }, [dataUpdate])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        const res = await handleUpdateNewsTagAction({
          id: dataUpdate.id,
          name,
          description,
          slug,
...
export default NewsTagUpdateModal;
