...
const commentFake: CommentType[] = [
  {
    ...
    author: "Michael Johnson",
    date: "2023-06-16",
    content: "Great article! I've been using Moodle for years and it's been a game-changer for our university.",
    likes: 12,
    replies: [
      {
        ...
        author: "Jane Smith",
        date: "2023-06-16",
        content: "Thanks Michael! Moodle is definitely one of the most versatile options out there.",
        likes: 3,
      },
    ],
  },
  {
    ...
    author: "Sarah Williams",
    date: "2023-06-17",
    content: "I've been considering implementing an LMS for our company's training program. This article was very helpful in understanding the options available.",
    likes: 8,
    replies: [],
  },
];
        ...
        if (postRes.statusCode === 200) {
          ...
          try {
            ...
            if (commentsRes.statusCode === 200) {
              ...
              setComments(commentsRes.data); // Uncomment nếu bạn muốn cập nhật state comments
            } else {
    ...
    try {
      ...
      if (response.statusCode === 201) {
        const newReply: ReplyType = {
          ...
          content: response.data.content,
          likes: 0,
          // Không cần avatar vì backend không trả về, hoặc thêm mặc định nếu muốn
        };
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 rounded-xl overflow-hidden">
            <Image
              src={
                `${process.env.NEXT_PUBLIC_BACKEND_URL}/${post.feature_image}` ||
                ai6
              }
              width={800}
              height={500}
