...
const QuizDetail = (props: any) => {
      ...
      const fetchData = async () => {
        ...
        try {
          ...
          if (data) {
            ...
            setAnswers(new Array(data.content.length).fill(null));
            setCorrectAnswers(new Array(data.content.length).fill(false));
          }
        } catch (error) {
    ...
    const handleNext = () => {
      if (currentQuestion < quizData.content.length - 1) {
        setCurrentQuestion(currentQuestion + 1);
      }
    };
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                  ...
                  <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                    ...
                    <div className="text-xl font-bold">
                      {Math.floor(quizData.time_limit / 60)} phút {quizData.time_limit % 60} giây
                    </div>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">
                ...
                {viewMode === "single" ? (
                  ...
                  <div>
                    <div className="mb-4 text-sm text-gray-500 dark:text-gray-400">
                      Câu hỏi {currentQuestion + 1} / {quizData.content.length}
                    </div>
                    ...
                    >
                      ...
                      <QuizQuestion
                        question={quizData.content[currentQuestion]}
                  ...
                  <div className="space-y-8">
                    <div className="mb-4 text-sm text-gray-500 dark:text-gray-400">
                      Tất cả câu hỏi ({quizData.content.length})
                    </div>
  
                    {quizData.content.map((question: any, index: any) => (
                      <div
                      ...
                      <div className="sticky bottom-4 bg-white dark:bg-gray-800 p-4 border-t border-gray-200 dark:border-gray-700 rounded-lg shadow-md">
                        <div className="flex justify-between items-center">
                          <div className="text-sm">
                            ...
                            / {quizData.content.length} câu đã trả lời
                          </div>
                        ...
                        {!allQuestionsAnswered && (
                          <div className="mt-2 text-amber-600 dark:text-amber-400 text-sm">
                            Bạn cần trả lời tất cả {quizData.content.length} câu
